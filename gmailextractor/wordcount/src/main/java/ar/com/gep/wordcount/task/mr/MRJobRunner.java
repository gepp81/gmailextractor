...
public class MRJobRunner<D extends Entity, KM extends Serializable, VM extends Serializable, R> {
    ...
    public MapReduceSpecification<EntryEntity, String, Integer, CountWordEntity, Void> getSpec() {
        ...
        MapReduceSpecification<EntryEntity, String, Integer, CountWordEntity, Void> spec = new MapReduceSpecification.Builder(
